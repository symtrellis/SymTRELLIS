"""
Copied directly from trellis2 repo,
performs normalization and extraction of points and vertices
"""
...
def main(arg):
    ...
    for obj in scene.objects:
        ...
        pack["faces"] = np.array([[eval_mesh.loops[i].vertex_index for i in poly.loop_indices] for poly in eval_mesh.polygons], dtype=np.int32)  # (F, 3)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Extract the faces and vertices of a given mesh into a pickle file")
